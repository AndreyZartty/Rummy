...
public class threadServidor extends Thread
{
     ...
     ArrayList<Partida> partidasLive = new ArrayList<>();
     ...
     public void run()
     {
    	...
    	while(true)
    	{
          try
          {
             ...
             {
                 case 10:
                     String nameP = entrada.readUTF();
                     int players = entrada.readInt();
                     Partida newP = new Partida(cliente, players);
                     partidasLive.add(newP);
                     // Creacion de Sala de Espera
                     break;
                ...
                case 6:
                    // lee el mensaje enviado desde el jframe
                     ...
                     enemigo.salida.writeInt(valorDados);
                break;
                case 7:
                    // lee el mensaje enviado desde el jframe
                     boolean specialBool = entrada.readBoolean();
                     double specialDouble = entrada.readDouble();
                     String specialString = entrada.readUTF();
                     enemigo.salida.writeInt(7);
                     enemigo.salida.writeBoolean(specialBool);
                     enemigo.salida.writeDouble(specialDouble);
                     enemigo.salida.writeUTF(specialString);
                break;
             }
          }
          catch (IOException e) {
