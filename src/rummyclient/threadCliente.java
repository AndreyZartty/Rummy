...
class threadCliente extends Thread{
   ...
   Juego vcli; //referencia acliente
            ...
            switch(opcion)
            {
               ...
               case 3://lee el numero del jugador
                ...
                case 6:
                    ...
                    // muestra el mensjae en pantalla.
                    vcli.mostrar("DADO " + valorDados);                    
                break;
                case 7:
                    boolean specialBool = entrada.readBoolean();
                    double specialDouble = entrada.readDouble();
                    String specialString = entrada.readUTF();
                    vcli.mostrar("BOOL " + specialBool);
                    vcli.mostrar("DOUBLE " + specialDouble);
                    vcli.mostrar("STRING " + specialString);
